Structure.create(description: "[1, 2, 3, 4, 5]", findable: '3')
Structure.create(description: "{'McDermott, O'Reilly and Orn'=>'generate integrated niches',
 ...
 'Ondricka, Auer and Thiel'=>'embrace efficient platforms'}", findable: 'transform revolutionary models')
Structure.create(description: "[-952, -482, 115, [63, -475, 378], -412, -25, -240, [-736, 5, -407]]", findable: '-407')
